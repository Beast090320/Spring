...
import com.study.spring.case06.proxy.dyn.cglib.EnhancerMessage;
...
public class TestDyn3 {
	public static void main(String[] args) {
		...
		/* 變更 Window -> Perferences -> Java -> Installed JREs (Edit) add 
		 * C:\Program Files\ojdkbuild\java-1.8.0-openjdk-1.8.0.312-1\jre
		 * 變更新增 Location路徑
		 **/
